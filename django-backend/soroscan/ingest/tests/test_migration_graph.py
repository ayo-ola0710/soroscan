...
def test_single_leaf_node():
    ...
    The current leaf is '0036_trackedcontract_network' (added by issue #277).
    """
    ...
    assert leaf_nodes[0][1] == "0036_trackedcontract_network", (
        "Expected leaf node '0036_trackedcontract_network', "
